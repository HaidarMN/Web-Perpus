        ...
        <div class="modal-dialog">
            <div class="modal-content" style="color: #ffffff; background-color: #616161;">
                ...
                <div class="modal-body">
				           <?php
					            $del=mysqli_query($koneksi,"SELECT * FROM `t_buku` WHERE id_buku='".$data['id_buku']."'");
                ...
                <div class="modal-footer">
                    ...
                    <a href="proses_delete_buku.php?id=<?php echo $data['id_buku']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="edit<?php echo $data['id_buku']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" style="color: #ffffff; background-color: #616161;">
                <div class="modal-body">
				<?php
					$edit=mysqli_query($koneksi,"SELECT * FROM `t_buku` WHERE id_buku='".$data['id_buku']."'");
					$editData=mysqli_fetch_array($edit);
				?>
				<div class="container-fluid">
                <form method="POST" action="proses_edit_buku.php?id=<?php echo $editData['id_buku']; ?>">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                          ...
                          <input type="number" name="id_kategori" class="form-control" value="<?php echo $editData['id_kategori']; ?>" required>
                      </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
